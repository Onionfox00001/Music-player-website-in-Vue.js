<template>
  <div class="d-flex flex-column justify-content-between min-vh-100 content-padding">
    <div class="col-md-8 mx-auto">
      <div class="text-white mb-3 mt-3">
        <h2 class="text-center">Some big name</h2>
      </div>
      <div class="body">
          ...
          <div v-for="(song, index) in filteredMusic" :key="song.id" class="col-lg-3 col-md-4 col-sm-6 mb-3" @click="playSong(song)">
            <div class="card bg-dark text-white h-100">
              <div class="card-body">
                ...
                <button class="btn btn-outline-success me-3" @click.stop="incrementLikes(song)" :disabled="likedSongs.has(song.id)">Like</button>
...
export default {
  ...
  methods: {
    ...
    incrementLikes(song) {
      if (!this.likedSongs.has(song.id)) {
        song.likes += 1;
